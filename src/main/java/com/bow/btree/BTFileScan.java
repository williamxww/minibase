             ...
             implements  GlobalConst
{
  ...
  *@exception com.bow.bufmgr.InvalidFrameNumberException  error from the lower layer
  *@exception com.bow.bufmgr.ReplacerException  error from the lower layer
  *@exception com.bow.bufmgr.PageUnpinnedException  error from the lower layer
  *@exception com.bow.bufmgr.HashEntryNotFoundException   error from the lower layer
  */
  public  void DestroyBTreeFileScan()
    throws  IOException, com.bow.bufmgr.InvalidFrameNumberException, com.bow.bufmgr.ReplacerException,
            com.bow.bufmgr.PageUnpinnedException, com.bow.bufmgr.HashEntryNotFoundException
  { 
     if (leafPage != null) {
         SystemDefs.JavabaseBM.unpinPage(leafPage.getCurPage(), true);
     } 
