...
import com.bow.iterator.*;
import com.bow.heap.*;
import com.bow.global.*;
import com.bow.index.*;
import java.io.*;
import java.util.*;
import java.lang.*;

import com.bow.btree.*;
...
class JoinsDriver implements GlobalConst {
  ...
  public void Query2() {
    ...
    //IndexType b_index = new IndexType(IndexType.B_Index);
    com.bow.iterator.Iterator am = null;
    ...
    try {
      sort_names = new Sort (JJtype,(short)1, JJsize,
			     (com.bow.iterator.Iterator) nlj2, 1, ascending, JJsize[0], 10);
    }
    catch (Exception e) {
      System.err.println ("*** Error preparing for nested_loop_join");
      System.err.println (""+e);
   ...
   public void Query3() {
    ...
    com.bow.iterator.Iterator am2 = null;
    try {
      am2 = new FileScan("reserves.in", Rtypes, Rsizes, 
				  (short)3, (short)3,
				  Rprojection, null);
  ...
  public void Query6()
	...
	Runtime.getRuntime().exit(1);
      ...
      try {
	sort_names = new Sort (JJtype,(short)1, JJsize,
			       (com.bow.iterator.Iterator) nlj, 1, ascending, JJsize[0], 10);
      }
      catch (Exception e) {
